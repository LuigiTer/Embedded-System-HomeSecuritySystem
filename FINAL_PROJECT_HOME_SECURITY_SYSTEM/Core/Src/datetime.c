...
/*
 * @fn		void retrive_current_date_time(TDatetime *datetime)
 ...
 */
void retrive_current_date_time(TDatetime *datetime) {
	int current_date[3] = { 0 };
	retrive_date(current_date);
	int current_time[3] = { 0 };
	retrive_time(current_time);
